...
% Lund University
%
% Example code 16: A bit more on BJ prediction (see also code 15).
%
% Reference: 
...
%% Estimate the BJ model (this is the model we found in code 15).
...
title( 'Predicting the output for k=1, 2, ...')
xlabel('Time')
