...
rain_t = rain_kalman_t;
x_all = rain_kalman;            % Remember that this is NOT transformed, AND in different time interval. 
...
% We need to make x more Gaussian in order to fit an ARMA. (?)
